...
@powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/VSpoon/WinSec/MAster/sysmon//sysmonconfig-export.xml','C:\ProgramData\sysmon\sysmonconfig-export.xml')"
@powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/VSpoon/WinSec/Master/sysmon//Auto_Update.bat','C:\ProgramData\sysmon\Auto_Update.bat')"
